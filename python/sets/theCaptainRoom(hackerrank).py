...
The list of room numbers contains 31  elements. Since k is 5, there must be 6 groups of families. In the given list, all of the numbers repeat  times except for room number .
Hence, 8 is the Captain's room number.
'''
# Enter your code here. Read input from STDIN. Print output to STDOUT
from collections import Counter
(_,a)=(input(),Counter(input().split()))
k=a.most_common()[:-2:-2]
print(k[0][0])
